import 'package:CanteenX/presentation/widgets/filter_bottom_sheet.dart';
...
PreferredSizeWidget homeAppBar(BuildContext context) {
  return PreferredSize(
    preferredSize: Size(double.infinity, AppDimensions.normalize(45)), //35
    child: Padding(
...
Widget trendingTitle(String text) {
  return Padding(
  ...
  return Row(
    ...
    children: [
      ...
      ...tags.asMap().entries.map((entry) {
        ...
        return Text(
          StringCapitalizeExtension("$tag${isLast ? ' ' : ', '}").capitalize(),
          style: textStyle,
          maxLines: 1,
