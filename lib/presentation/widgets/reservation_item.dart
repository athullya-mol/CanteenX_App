    ...
    children: [
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Space.yf(.7),
            Text(
              StringCasingExtension(reservation.restaurant.toString())
                  .capitalize(),
              style: AppText.h2b,
            ),
            Space.yf(.3),
            Row(
              children: [
                ...
                Text(
                  StringCapitalizeExtension(reservation.branch.toString())
                      .capitalize(),
                  style: AppText.b1,
                ),
              ],
      ...
      Positioned(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: reservation.status.toLowerCase() == 'accepted'
                ? Colors.green
                : AppColors.deepRed,
          ...
          child: Text(
            StringCasingExtension(reservation.status).capitalize(),
